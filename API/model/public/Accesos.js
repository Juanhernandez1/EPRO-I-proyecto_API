...
var Accesos = /*#__PURE__*/function (_Model) {
  (0, _inherits2["default"])(Accesos, _Model);

  var _super = _createSuper(Accesos);

  function Accesos() {
    (0, _classCallCheck2["default"])(this, Accesos);
    return _super.apply(this, arguments);
  }

  (0, _createClass2["default"])(Accesos, null, [{
    key: "init",
    value: function init(sequelize, DataTypes) {
      (0, _get2["default"])((0, _getPrototypeOf2["default"])(Accesos), "init", this).call(this, {
        UidUsuario: {
    ...
    value: function Setting() {
      ...
      var campoE = this.fieldAttributeMap.tipo; // * objetos para comparacion
