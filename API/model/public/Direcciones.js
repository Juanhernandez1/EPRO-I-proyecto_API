...
var Direcciones = /*#__PURE__*/function (_Model) {
  (0, _inherits2["default"])(Direcciones, _Model);

  var _super = _createSuper(Direcciones);

  function Direcciones() {
    (0, _classCallCheck2["default"])(this, Direcciones);
    return _super.apply(this, arguments);
  }

  (0, _createClass2["default"])(Direcciones, null, [{
    key: "init",
    value: function init(sequelize, DataTypes) {
      (0, _get2["default"])((0, _getPrototypeOf2["default"])(Direcciones), "init", this).call(this, {
        UidNegocio: {
